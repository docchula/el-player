            ...
            <div class="px-6 py-4">
              ...
              <div class="mt-4">
                <a
                  ...
                  @click.prevent=""
                >
                  Play with Docchula Player
                </a>
                <p class="my-2">
                  Drag the link above to your bookmark bar. Then, when you're
                  visiting a video page, click the bookmark to play the video
                  with Docchula Player.
                </p>
                <p class="my-2">
                  Press Ctrl + Shift + B to show your bookmark bar.
                </p>
              </div>
            </div>

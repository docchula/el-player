...
<template>
        ...
        <div>
          ...
          <div class="flex items-center gap-2">
            <input
              ...
              class="block w-28 rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
              max="360"
              min="1"
              placeholder="25"
              type="number"
  ...
  <div class="absolute left-0 top-0 h-1.5 w-screen">
    <div
      :class="{
        'bg-primary-400 dark:bg-primary-700': timer.title === 'Study',

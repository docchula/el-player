...
<template>
        ...
        <div>
          ...
          <div class="flex items-center gap-2">
            <input
              ...
              class="block w-28 rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6"
              max="360"
              min="1"
              placeholder="25"
              type="number"
  ...
  <div class="absolute top-0 left-0 w-screen h-1.5">
    <div
      :class="{
        'bg-orange-400 dark:bg-orange-700': timer.title === 'Study',

...
<template>
  <form @submit.prevent="$emit('submit', url)">
    <div class="mb-4">
      <label for="url" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Video URL</label>
    ...
    <button type="submit" :disabled="!url" :class="{ 'border-green-500 text-green-500 dark:text-green-500': url, 'border-gray-500 dark:text-gray-500': !url }"

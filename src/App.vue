...
<template>
  <div
    ...
    <div class="absolute top-0 right-0 px-6 py-4 block font-light">
      <a href="http://e-learning.md.chula.ac.th" target="_blank"
        class="text-sm text-gray-500 dark:text-gray-400 underline">MDCU E-Learning</a>
    </div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 sm:mt-0">
      <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
        <h1 class="text-6xl font-extrabold md:px-4 lg:px-12">
          <span
            class="text-transparent bg-clip-text bg-gradient-to-br from-emerald-300 dark:from-emerald-200 to-green-700 dark:to-green-600">Docchula</span>
      ...
      <div class="mt-20 mb-4 text-xs font-light text-gray-400 transition duration-1000 dark:text-gray-300 text-center">
        ...
        <a href="https://github.com/docchula/el-player" target="_blank"
          class="text-slate-300 dark:text-slate-500 hover:underline hover:text-gray-400 dark:hover:text-gray-300">Source
          Code</a>&nbsp;|&nbsp;
        <a href="http://player-v1.docchula.com" target="_blank"
          class="text-slate-300 dark:text-slate-500 hover:underline hover:text-gray-400 dark:hover:text-gray-300">v1
          player</a>&nbsp;|&nbsp;
